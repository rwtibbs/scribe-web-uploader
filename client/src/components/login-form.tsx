...
export function LoginForm() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#01032d] to-[#010101] flex items-center justify-center px-4">
        ...
        <Card className="bg-black/20 backdrop-blur-sm border-game-primary/20">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {/* Environment selection removed - production only */}
              ...
              <div className="relative my-4">
                <div className="absolute inset-0 flex items-center">
                  <div className="w-full border-t border-game-primary/20"></div>
                </div>
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-black/20 text-game-secondary">Or continue with</span>
                </div>
              </div>
